...
typedef struct pentry
{
    ...
    void *stkptr;       /**< base of run time stack                  */
...
/* Priority constants */
#define PRIORITY_LOW	1       /**< low process priority		 */
#define PRIORITY_MED	2       /**< medium process priority		 */
#define PRIORITY_HIGH	3       /**< high process priority		 */
