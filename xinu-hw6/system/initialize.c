...
void nulluser(void)
{
    ...
    /* TODO: This won't compile properly until you make necessary changes
     * to create.c
     */
...
static int sysinit(void)
{
    ...
    ppcb->stkptr = NULL;
    /**
     * TODO: This won't compile properly until you add necessary changes to
     * proc.h
     */
    ppcb->tickets = PRIORITY_LOW;
    currpid = NULLPROC;
